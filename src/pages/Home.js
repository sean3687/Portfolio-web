...
const Home = props => {
    return (
        ...
        <div className = "Title">
            ...
            <h4>Hi, my Name is,</h4>
            <h1>Sean Jin</h1>
            <p className = "title-paragraph"><span className="hover-underline-animation">I'm a software engineer based in Irvine, CA</span> speecializing in building(and ocationally desgining) exceptional website,application, and everything in between</p>
